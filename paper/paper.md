...
`lms` [@lms], `lts` [@lts], `galts` [@galts], `satman2013` [@satman2013], `satman2015` [@satman2015] for regression data, and `hadi1992` [@hadi1992], `hadi1994` [@hadi1994], `ccf` [@ccf], `mve` [@mve], `mcd` [@mcd], and `dataimage` [@dataimage] for multivariate data.
